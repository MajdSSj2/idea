                                    ...
                                    <button type="submit" role="checkbox"
                                            class="size-5
                                             ...
                                             rounded-lg
                                              ...
                                              {{$step->isCompleted ? 'bg-primary' : 'border border-primary'}}">
                                        &check;
                                    </button>
                                    <span
                                        class="{{ $step->isCompleted ? 'line-through text-muted-foreground' : ''}}">{{ $step->description }}</span>
                                </div>
                            </form>
                        </x-card>
                    @endforeach
